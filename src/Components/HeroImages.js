    ...
    return (
        <div className="hero__image__container">
            <div className="hero__images">
                <img
                    className={`hero__tesla hero__img ${heroImageHome}`}
                    src={tesla}
                    alt="tesla corporation private limited"
                />
                <img
                    className={`hero__microsoft hero__img ${heroImageHome}`}
                    src={microsoft}
                    alt="microsoft corporation private limited"
                />
                <img
                    className={`hero__hewlett hero__img ${heroImageHome}`}
                    src={hewlett}
                    alt="hewlett parkard corporation private limited"
                />
                <img
                    className={`hero__oracle hero__img ${heroImageHome}`}
                    src={oracle}
                    alt="oracle corporation private limited"
                />
                <img
                    className={`hero__google hero__img ${heroImageHome}`}
                    src={google}
                    alt="google corporation private limited"
                />
                <img
                    className={`hero__nvidia hero__img ${heroImageHome}`}
                    src={nvidia}
